<section class="main">
  ...
  <section class="main-services wrap">
    <h1>Услуги</h1>
    <div class="main-services-content flexbox">
      <? foreach($cont[servicesText] as $value): ?>
      <article class="shadow flexbox">
        <p><?= $value[about]?></p>
      </article>
      <? endforeach; ?>
    </div>
  </section>
  <section class="main-content flexbox wrap">
    <? if($cont[news]):?>
      ...
      <article class="main-product shadow">
        <div class="product-img flexbox"><img src="<?= $value[photo]?>"></div>
  ...
  <?else:?>
    <section class="main-products no-news">
      <h1>Продукты</h1>
      <div class="flexbox">
        <? foreach($cont[products] as $value): ?>
        <article class="main-product shadow">
